# Nurzhan-Kozhakhmetov-Intro-26.2-Class
Portfolio project for Intro 26.2 Class to programming course with Code the Dream
...
console.log("Q1 convertTemp (warm): ", 25, convertTemp(25));
console.log("Q1 convertTemp (hot): ", 35, convertTemp(35));
console.log("Q1 convertTemp (cold): ", -10, convertTemp(-10));
console.log("Q1 convertTemp (boiling): ", 100, convertTemp(100));
...
console.log("Q2 reverseString: ", input1, reverseString(input1));

// Check
let input2 = "JavaScript";
console.log("Q2 reverseString: ", input2, reverseString(input2));

// Check emty stroke
let input3 = "";
console.log("Q2 reverseString (empty): ", "'" + input3 + "'", "'" + reverseString(input3) + "'");
...
console.log("Q3 tipCalculator: ", bill, tipPart, tipCalculator(bill, tipPart));

console.log("Q3 tipCalculator (another test): ", 20, 0.15, tipCalculator(20, 0.15));
...
console.log("Q5 getAverage (another test): ", 10, 20, getAverage(10.0, 20.0));
...
let test1 = 12;
console.log("Q6 isPrime: ", test1, isPrime(test1));

//Test prime numbers
let test2 = 7;
console.log("Q6 isPrime (prime): ", test2, isPrime(test2));

let test3 = 17;
console.log("Q6 isPrime (prime): ", test3, isPrime(test3));

//Test composite numbers
let test4 = 15;
console.log("Q6 isPrime (composite): ", test4, isPrime(test4));

//Test 0 and 1 (edge ​​cases)
let test5 = 0;
console.log("Q6 isPrime (zero): ", test5, isPrime(test5));

let test6 = 1;
console.log("Q6 isPrime (one): ", test6, isPrime(test6));
...
console.log("Q7 getPrimesUpTo: ", 1, getPrimesUpTo(1));    // []
...
function calculateAverage(scoresArray) {
    ...
    for (let i = 0; i < scoresArray.length; i++) {
        let currentScore = scoresArray[i];
...
let scores2 = [90, -50, 80, 150, 85];
console.log("Q8 calculateAverage (with bad data): ", calculateAverage(scores2));
let scores3 = [];
console.log("Q8 calculateAverage (empty): ", calculateAverage(scores3));
...
// The function converts a GPA into a letter grade.
...
console.log("Q9 getLetterGrade: ", getLetterGrade(60));
...
// Let's check if the student passed the exam.
...
// All calculations and output to the summary row.
function printClassResult(className, student, scores) {
    // calculate the average score using the function from Question 8.
    let average = calculateAverage(scores);

    // obtain the letter grade using the function from Question 9.
    let grade = getLetterGrade(average);

    // check whether the student has passed using the function from Question 10
    let isPassed = passed(grade);

    // converting true/false to "yes" or "no".
    let passedText = "no";
    if (isPassed === true) {
        passedText = "yes";
    }
    ...
    return `${className} - Student: ${student}, Average: ${average}, Grade: ${grade}, Passed: ${passedText}`;
}

// Testing
console.log("Q11: ", printClassResult("History 101", "Jane Doe", [60, 70, 85, 87]));

console.log("Q11 (Failed student): ", printClassResult("Math 202", "John Smith", [50, 40, 62]));
...
function simulateButtonPush(callbackFunction) {
    callbackFunction();
}
